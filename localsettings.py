...
DEFAULT_FROM_EMAIL = 'info@ttree.ch'

# Address to receive messages sent by contact form.
CONTACT_EMAIL = 'info@ttree.ch'
...
EMAIL_HOST_USER = 'typo3pootle@gmail.com'
EMAIL_HOST_PASSWORD = 'jDZ99ZxgksBYnRNXv'
...
DATABASE_PASSWORD = '8KSydTyHaTRBpPH4'
